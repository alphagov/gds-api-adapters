...
describe GdsApi::Search do
  ...
  it "#delete_content removes a document" do
    ...
    GdsApi::Search.new("http://example.com").delete_content("/foo/bar")
  ...
  it "#get_content Retrieves a document" do
    ...
    GdsApi::Search.new("http://example.com").get_content("/foo/bar")
  ...
  it "#delete_document using V1 API" do
    ...
    GdsApi::Search.new("http://example.com").delete_document("edition", 123)
  ...
  it "#delete_document using V2 API" do
    ...
    GdsApi::Search.new("http://example.com", api_version: "V2").delete_document(123, "metasearch")

    assert_requested(request)
  end

  it "#delete_document using V2 API - can't delete from non-metasearch index" do
    assert_raises GdsApi::Search::V2::InvalidIndex do
      GdsApi::Search.new("http://example.com", api_version: "V2").delete_document(123, "government")
    end
  end

  it "can't use an unknown api version" do
    assert_raises GdsApi::Search::UnknownAPIVersion do
      GdsApi::Search.new("http://example.com", api_version: "V0")
    end
  end
  ...
  it "#add_document using V1 API" do
    ...
    GdsApi::Search.new("http://example.com").add_document("edition", 123, {})
  ...
  it "#add_document using V2 API" do
    ...
    GdsApi::Search.new("http://example.com", api_version: "V2").add_document(123, {}, "metasearch")
  ...
  it "#add_document using V2 API - can't insert into non-metasearch index" do
    assert_raises GdsApi::Search::V2::InvalidIndex do
      GdsApi::Search.new("http://example.com", api_version: "V2").add_document(123, {}, "government")
    end
  end
end
