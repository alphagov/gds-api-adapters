...
describe GdsApi::AssetManager do
  ...
  it "creates an asset with a file" do
    req = stub_request(:post, "#{@base_api_url}/assets").
      ...
      to_return(:body => %|{"asset":{"id":"#{@base_api_url}/assets/51278b2b686c82076c000003"}}|, :status => 201)

    response = @api.create_asset(:file => file_fixture)

    assert_equal "#{@base_api_url}/assets/51278b2b686c82076c000003", response.asset.id
